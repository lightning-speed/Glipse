		...
		btnExport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(textField.getText().length()<=0) {
				 ...
				 int result = JOptionPane.showConfirmDialog(launcher.win,"Your Jar has been exported to "+System.getProperty("user.home")+"\\GlipseBuilds", "Export",
